...
public class Message {
    ...
    public static final String GET_REGISTRATION_PLO_SUCCESS = "Get Registration by Parking Lot Owner Id Success";
    //Rating
    ...
    public static final String NOT_FOUND_PLO_BY_KEY_WORD = "Not Found Parking Lot Owner By Key Word With Parking Status";
